...
const CreatorDashboard = () => {
  ...
  return (
    <>
      ...
      {/* Welcome section */}
      <section className="mb-8 pt-6 relative">
        <motion.h1 
      ...
      >
        <div className="flex flex-wrap gap-4">
          <Button 
            className="bg-gradient-synthwave hover:shadow-neon-pink gap-2 transition-all duration-300"
            onClick={() => {
          ...
          <Button 
            variant="outline" 
            className="border-audio-synthwave-purple border-opacity-50 hover:border-opacity-100 hover:bg-audio-synthwave-purple/20 gap-2 transition-all duration-300"
          ...
          <Button 
            variant="outline" 
            className="border-audio-synthwave-teal border-opacity-50 hover:border-opacity-100 hover:bg-audio-synthwave-teal/20 gap-2 transition-all duration-300"
            onClick={() => playSoundEffect('click')}
          >
            <Users size={18} />
            Gérer la communauté
          ...
          <Button 
            variant="outline" 
            className="border-audio-synthwave-pink border-opacity-50 hover:border-opacity-100 hover:bg-audio-synthwave-pink/20 gap-2 transition-all duration-300"
            onClick={() => playSoundEffect('click')}
          >
            <Rocket size={18} />
            Promouvoir
          ...
          {stats.map((stat, index) => (
            ...
            >
              <Card className="bg-black/40 backdrop-blur-md border-white/5 overflow-hidden relative">
                <div className="absolute inset-0 bg-gradient-to-br from-audio-synthwave-purple/20 via-transparent to-transparent"></div>
      ...
      {activeTab === 'trending' && (
        ...
        >
          ...
          <Card className="bg-black/40 backdrop-blur-md border-white/5 overflow-hidden relative">
            <div className="absolute inset-0 bg-gradient-to-br from-audio-synthwave-blue/10 via-transparent to-audio-synthwave-purple/10"></div>
